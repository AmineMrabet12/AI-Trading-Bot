...
def ws_trades(connection): 
    socket = f'wss://stream.binance.com:9443/ws/omniusdt@trade'
...
def handle_trades(connection, json_message):
    ...
    query = f"insert into crypto.OMNI_stream values ({json_message['t']}, '{json_message['e']}', '{Event_time}', '{json_message['s']}', '{json_message['p']}', {json_message['q']}, {json_message['b']}, {json_message['a']}, '{Trade_time}', {json_message['m']}, {json_message['M']});"
